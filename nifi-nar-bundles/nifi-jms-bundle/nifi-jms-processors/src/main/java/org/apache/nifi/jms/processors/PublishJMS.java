...
@CapabilityDescription("Creates a JMS Message from the contents of a FlowFile and sends it to a JMS Destination (queue or topic).")
public class PublishJMS extends AbstractJMSProcessor<JMSPublisher> {
     ...
     * <br><br>
     * Upon success the incoming {@link FlowFile} is transfered to the'success'
     * {@link Relationship} and upon failure FlowFile is penalized and
     * transfered to the 'failure' {@link Relationship}
     *
     */
    @Override
