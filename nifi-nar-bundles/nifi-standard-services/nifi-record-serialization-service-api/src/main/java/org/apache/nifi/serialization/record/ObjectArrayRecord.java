...
public class ObjectArrayRecord implements Record {
    ...
    public ObjectArrayRecord(final RecordSchema schema, final Object[] values) {
    ...
    public Object getValue(final String fieldName) {
        final OptionalInt index = schema.getFieldIndex(fieldName);
        if (index.isPresent()) {
    ...
    public Long getAsLong(final int index) {
        return convertToLong(getValue(index), index);
    }
    ...
    @Override
    public Integer getAsInt(final int index) {
        return convertToInt(getValue(index), index);
    }
    ...
    public Double getAsDouble(final int index) {
        return convertToDouble(getValue(index), index);
    }
    ...
    public Float getAsFloat(final int index) {
        return convertToFloat(getValue(index), index);
    }
    ...
    @Override
    public Record getAsRecord(final int index) {
        return convertToRecord(getValue(index), index);
    }
    ...
    public Boolean getAsBoolean(final int index) {
        return convertToBoolean(getValue(index), index);
    }
    ...
    public Date getAsDate(final int index) {
        final String format = schema.getField(index).getDataType().getFormat();
    ...
    @Override
    public Object[] getAsArray(final int index) {
        return convertToArray(getValue(index));
    }
